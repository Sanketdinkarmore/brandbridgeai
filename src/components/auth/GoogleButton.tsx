...
export default function GoogleButton({ role, mode = "signup" }: GoogleButtonProps) {
  if (!role) {
    return (
      <button
        type="button"
  ...
  // Use a plain anchor — NOT next/link — so the browser does a full
  // navigation to our API route instead of an RSC prefetch (which fails on 307 redirects).
  return (
    <a
